...
//
//    @PostMapping
//    public ResponseEntity<CreateCouponResponseDTO> createSchedule(
//            @RequestBody CouponDTO request) {
//        return ResponseEntity.status(HttpStatus.CREATED).body(couponBO.createCoupon(request));
//    }
//
//    @GetMapping("code/{code}")
//    public ResponseEntity<CreateCouponResponseDTO> getCouponByCode(@PathVariable String code) {
//        return ResponseEntity.ok(couponBO.getCouponByCode(code));
//    }
//
//    @GetMapping("/{id}")
//    public ResponseEntity<CreateCouponResponseDTO> getCouponById(@PathVariable UUID id) {
//        return ResponseEntity.ok(couponBO.getCouponById(id));
//    }
//
//    @PatchMapping("/{id}/publish")
//    public ResponseEntity<CreateCouponResponseDTO> publishCoupon(@PathVariable UUID id) {
